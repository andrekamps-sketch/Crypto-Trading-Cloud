...
CANDIDATES = ["crypto_trading_bot_v4_7", "crypto_trading_bot_v4_6", "crypto_trading_bot_v4_5"]
...
def main() -> None:
    ...
    if source is None:
        print("Kein V4.7/V4.6-Paper-Konto im gleichen uebergeordneten Ordner gefunden.")
