...
CANDIDATES = ["crypto_trading_bot_v4_5", "crypto_trading_bot_v4_4", "crypto_trading_bot_v4_3", "crypto_trading_bot_v4_2"]
...
def main() -> None:
    ...
    if source is None:
        print("Kein V4.5/V4.4-Paper-Konto im gleichen uebergeordneten Ordner gefunden.")
    ...
    print("Offene V4.5-Positionen behalten ihre gespeicherte Strategiekennung.")
    input("Enter druecken zum Schliessen ...")
