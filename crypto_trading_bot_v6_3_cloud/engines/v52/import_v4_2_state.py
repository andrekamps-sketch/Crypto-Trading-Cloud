...
CANDIDATES = ["crypto_trading_bot_v4_2", "crypto_trading_bot_v4_1", "crypto_trading_bot_v4"]
...
def main() -> None:
    ...
    for name in CANDIDATES:
        ...
        if folder.exists() and (folder / "scanner_state.json").exists():
            ...
            break
    if source is None:
        print("Kein V4.2/V4-Paper-Konto im gleichen uebergeordneten Ordner gefunden.")
